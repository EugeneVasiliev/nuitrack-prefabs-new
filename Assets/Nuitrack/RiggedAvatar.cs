...
public class RiggedAvatar : MonoBehaviour 
{
  ...
  collarRight;
    ...
    if (CurrentUserTracker.CurrentUser != 0)
      ...
      Vector3 torsoPos = (rotate180 ? q180 : q0) * (Vector3.up * CalibrationInfo.FloorHeight + CalibrationInfo.SensorOrientation * ( 0.001f * skeleton.GetJoint(nuitrack.JointType.Torso).ToVector3()));
      basePivot.transform.position = torsoPos;
